             ...
             <tbody>
                ...
                ?>
                   <tr>
                     ...
                     <td><?php echo "<a href='".base_url("index.php/produtos_c/edt?id_p=".$value['id_produto'])."'>".$value['nome']."</a>"; ?></td>
                     <td><?php echo $value['tp'] ?></td>
                     <td><?php echo "<a href='".base_url("index.php/produtos_c/del?id_p=".$value['id_produto'])."' onclick='return confirmDialog();'><i class='fa fa-trash'></i></a>"; ?></td>
                   </tr>  
                 <?php $c++; }}else{ ?>
                 <tr>
