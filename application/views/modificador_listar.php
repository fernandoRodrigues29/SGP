          ...
          <thead>
            <tr>
             ...
             <tbody>
                ...
                ?>
                   <tr>
                     <td><?php echo $value['id_modificador'] ?></td>  
                     <td><?php echo "<a href='".base_url("index.php/modificador_c/edit?id_m=".$value['id_modificador'])."'>".$value['marca']."</a>"; ?></td>
                      <td><?php echo $value['validade'] ?></td>  
                     <td><?php echo "<a href='".base_url("index.php/modificador_c/del?id_m=".$value['id_modificador'])."' onclick='return confirmDialog();'><i class='fa fa-trash'></i></a>"; ?></td>
                   </tr>  
                 <?php $c++; }}else{ ?>
                 <tr>
