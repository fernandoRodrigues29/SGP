          ...
          <thead>
            <tr>
             ...
             <tbody>
                ...
                ?>
                   <tr>
                     <td><?php echo $value['id_estoque'] ?></td>  
                     <td><?php echo "<a href='".base_url("index.php/estoque_c/edit?id_e=".$value['id_estoque'])."'>".$value['nome']."</a>"; ?></td>
                     <td><?php echo $value['qtd'];?></td>
					 <td><?php echo "<a href='".base_url("index.php/estoque_c/del?id_e=".$value['id_estoque'])."' onclick='return confirmDialog();'><i class='fa fa-trash'></i></a>"; ?></td>
                   </tr>  
                 <?php $c++; }}else{ ?>
                 <tr>
