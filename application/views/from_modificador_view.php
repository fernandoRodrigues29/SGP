        ...
        <form class="form-horizontal"  action="<?php echo base_url("$action"); ?>" id="myform" method="POST"  role="form" >
            ...
            <div class="row">
                <div class="col-md-5 input-group">
				    ...
				    <input type="text" name="marca" value="<?php if (isset($marca)) {	echo $marca;	} ?>" class="form-control" id="marca" placeholder="Marca">
                </div>
            </div><br>
			<div class="row">
                <div class="col-md-5 input-group">
                    <span class="input-group-addon" ><i class="fa fa-gear"></i></span>
		 <input type="text" name="percent" value="<?php if (isset($percent)) {	echo $percent;	} ?>" class="form-control" id="valmasc" >
                </div>
            </div><br>
			<div class="row">
                <div class="col-md-5 input-group">
