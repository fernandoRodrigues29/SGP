             ...
             <tbody>
                ...
                ?>
                   <tr>
                     ...
                     <td><?php echo "<a href='".base_url("index.php/tipos_c/edit?id_t=".$value['id_tipo'])."'>".$value['tipo']."</a>"; ?></td>
                     <td><?php echo "<a href='".base_url("index.php/tipos_c/del?id_t=".$value['id_tipo'])."' onclick='return confirmDialog();'><i class='fa fa-trash'></i></a>"; ?></td>
                   </tr>  
                 <?php $c++; }}else{ ?>
                 <tr>
