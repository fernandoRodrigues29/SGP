             ...
             <tbody>
                ...
                ?>
                   <tr>
                     ...
                     <td><?php echo "<a href='".base_url("index.php/cliente_c/edit?id_c=".$value['id_cliente'])."'>".$value['nome']."</a>"; ?></td>
              	     <td><?php echo "<a href='".base_url("index.php/cliente_c/del?id_c=".$value['id_cliente'])."' onclick='return confirmDialog();'><i class='fa fa-trash'></i></a>"; ?></td>
                   </tr>  
                 <?php $c++; }}else{ ?>
                 <tr>
...
$(document).ready(function(){
   $("#botao").click(function(){
        ...
        $('#botao').show();
        $.post("<?php echo base_url('index.php/cliente_c/pesquisar');?>",
        { valor: texto},
        function(result){
             window.location = "<?php echo base_url('index.php/cliente_c/view_filtro_arr');?>";
        });
    });
});
</script>
