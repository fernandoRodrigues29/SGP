...
-- Copiando estrutura do banco de dados para frell_codeign
CREATE DATABASE IF NOT EXISTS `frell_codeign` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `frell_codeign`;


-- Copiando estrutura para tabela frell_codeign.auditoria
CREATE TABLE IF NOT EXISTS `auditoria` (
  `id_auditoria` int(11) NOT NULL AUTO_INCREMENT,
  `acao` varchar(11) NOT NULL,
  `data_cad` date NOT NULL,
  `id_atuante` int(11) NOT NULL,
  `id_alvo` int(11) NOT NULL,
  PRIMARY KEY (`id_auditoria`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.auditoria: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `auditoria` DISABLE KEYS */;
INSERT INTO `auditoria` (`id_auditoria`, `acao`, `data_cad`, `id_atuante`, `id_alvo`) VALUES
	(1, 'IN', '2016-08-12', 0, 0),
	(2, 'edit_venda', '2016-08-12', 0, 0),
	(3, 'cad_cliente', '2016-08-13', 1, 1);
/*!40000 ALTER TABLE `auditoria` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.backup_mensagem
CREATE TABLE IF NOT EXISTS `backup_mensagem` (
  `usuario_id` int(11) NOT NULL,
  `m_pai` int(11) NOT NULL,
  `tempo_hora` datetime NOT NULL,
  `texto` text NOT NULL,
  `tempo_del` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.backup_mensagem: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `backup_mensagem` DISABLE KEYS */;
/*!40000 ALTER TABLE `backup_mensagem` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.cliente
CREATE TABLE IF NOT EXISTS `cliente` (
  `id_cliente` int(11) NOT NULL AUTO_INCREMENT,
  `contato` varchar(20) NOT NULL,
  `email` varchar(200) NOT NULL,
  `uf` varchar(2) NOT NULL,
  `munic` int(11) NOT NULL,
  `end` varchar(200) NOT NULL,
  `nome` varchar(150) NOT NULL,
  PRIMARY KEY (`id_cliente`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.cliente: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
INSERT INTO `cliente` (`id_cliente`, `contato`, `email`, `uf`, `munic`, `end`, `nome`) VALUES
	(1, '2345678', 'gpensador@gmail.vc', 'PE', 260090, 'qd 302 bl vivaz artur ap3', 'juliano toniolo'),
	(2, '2344444', 'mlp@mlp.com', 'MG', 310010, 'qd 302 bl vivIane ap3', 'batata'),
	(3, '0', '0', 'PB', 250010, '0', 'anonimo');
/*!40000 ALTER TABLE `cliente` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.demandas
CREATE TABLE IF NOT EXISTS `demandas` (
  `id_demanda` int(11) NOT NULL AUTO_INCREMENT,
  `demanda` text NOT NULL,
  `data_inicio` date NOT NULL,
  `data_comclusao` date NOT NULL,
...
-- Copiando dados para a tabela frell_codeign.demandas: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `demandas` DISABLE KEYS */;
INSERT INTO `demandas` (`id_demanda`, `demanda`, `data_inicio`, `data_comclusao`, `status`, `fk_funcionario`) VALUES
	(1, 'demanda padrão conjunto adnominal pros moderno', '1906-06-30', '1906-06-22', 1, 5),
	(2, 'pd2', '2016-08-12', '2016-08-26', 1, 2),
	(3, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus eget tellus auctor, vestibulum erat id, volutpat enim. Vestibulum consectetur sodales tincidunt. Mauris fermentum, leo nec tincidunt interdum, libero dolor accumsan ipsum, vel gravida nibh dui nec eros. Vestibulum sit amet fermentum enim, a tempus nulla. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Suspendisse at maximus ligula, id tincidunt orci. Maecenas consectetur nibh quis nisl consectetur, at mattis mi interdum', '2016-10-12', '2016-10-29', 1, 6);
/*!40000 ALTER TABLE `demandas` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.estados
CREATE TABLE IF NOT EXISTS `estados` (
  `id` int(11) NOT NULL,
  `codigo_uf` int(11) NOT NULL,
  `estado` varchar(25) NOT NULL,
  `UF` char(2) NOT NULL,
  `Regiao` varchar(18) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.estados: ~27 rows (aproximadamente)
/*!40000 ALTER TABLE `estados` DISABLE KEYS */;
INSERT INTO `estados` (`id`, `codigo_uf`, `estado`, `UF`, `Regiao`) VALUES
	(1, 12, 'Acre', 'AC', 'Norte'),
...
-- Copiando estrutura para tabela frell_codeign.estoque
...
-- Copiando dados para a tabela frell_codeign.estoque: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `estoque` DISABLE KEYS */;
INSERT INTO `estoque` (`id_estoque`, `fk_produto`, `qtd`) VALUES
	(1, 1, 252),
	(2, 2, 31),
	(3, 7, 4780),
	(4, 8, 0),
...
-- Copiando estrutura para tabela frell_codeign.gm_maker
CREATE TABLE IF NOT EXISTS `gm_maker` (
  `long` varchar(11) NOT NULL,
  `lat` varchar(11) NOT NULL,
  `id_produto` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.gm_maker: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `gm_maker` DISABLE KEYS */;
/*!40000 ALTER TABLE `gm_maker` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.google _ users
CREATE TABLE IF NOT EXISTS `google _ users` (
  `google _ id` decimal(21,0) NOT NULL,
  `google _ name` varchar(60) NOT NULL,
  `google _ email` varchar(60) NOT NULL,
  `google _ link` varchar(60) NOT NULL,
  `google _ picture _ link` varchar(200) NOT NULL,
  PRIMARY KEY (`google _ id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.google _ users: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `google _ users` DISABLE KEYS */;
/*!40000 ALTER TABLE `google _ users` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.imagen_produto
CREATE TABLE IF NOT EXISTS `imagen_produto` (
  `id_img` int(11) NOT NULL,
  `fkproduto` int(11) NOT NULL,
  `img` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.imagen_produto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `imagen_produto` DISABLE KEYS */;
/*!40000 ALTER TABLE `imagen_produto` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.mensagem
CREATE TABLE IF NOT EXISTS `mensagem` (
  `id_mensagem` int(11) NOT NULL AUTO_INCREMENT,
  `id_m_pai` int(11) NOT NULL,
  `id_remetente` int(11) NOT NULL,
  `id_destinatario` int(11) NOT NULL,
  `tempo_hora` datetime NOT NULL,
  `texto` text NOT NULL,
  `visibilidade` char(4) NOT NULL,
  `visto` char(2) DEFAULT NULL,
  PRIMARY KEY (`id_mensagem`),
  KEY `usuario_id` (`id_remetente`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.mensagem: ~12 rows (aproximadamente)
/*!40000 ALTER TABLE `mensagem` DISABLE KEYS */;
INSERT INTO `mensagem` (`id_mensagem`, `id_m_pai`, `id_remetente`, `id_destinatario`, `tempo_hora`, `texto`, `visibilidade`, `visto`) VALUES
	(1, 0, 6, 5, '2016-10-21 06:09:10', 'Integer lacinia semper interdum. Fusce aliquam feugiat lectus id pharetra. Aenean posuere facilisis scelerisque. Phasellus venenatis turpis sit amet sapien interdum semper vel nec diam. Nulla vestibulum in lectus a porta. Aliquam ut lectus blandit, viverra sem et, lobortis lacus. Nulla convallis pulvinar libero, eu facilisis metus ultrices eget', 'P', NULL),
	(2, 1, 5, 6, '2016-10-22 15:33:29', 'que merda e essa que você esta falando?', 'p', NULL),
	(3, 1, 6, 5, '2016-10-22 15:33:45', 'oxente você não fiu?', 'p', NULL),
	(18, 1, 6, 5, '2016-10-21 08:10:14', 'so para testar', 'P', 'N'),
	(19, 1, 6, 5, '2016-10-21 08:10:16', 'vai rolar', 'P', 'N'),
	(20, 1, 6, 5, '2016-10-21 08:10:21', 'vai rolar', 'P', 'N'),
	(21, 1, 6, 5, '2016-10-21 08:10:31', 'xicxic', 'P', 'N'),
	(22, 1, 6, 5, '2016-10-23 12:10:04', 'jigboy', 'P', 'N'),
	(23, 1, 5, 6, '2016-10-23 12:10:14', 'oxente', 'P', 'N'),
	(31, 1, 6, 5, '2016-10-23 09:10:04', 'metis', 'P', 'N'),
	(33, 0, 2, 5, '2016-10-23 09:10:18', '2 conteudo', 'P', 'N'),
	(34, 33, 2, 5, '2016-10-23 09:10:55', 'xesperito', 'P', 'N');
/*!40000 ALTER TABLE `mensagem` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.modificadores
CREATE TABLE IF NOT EXISTS `modificadores` (
  `id_modificador` int(11) NOT NULL AUTO_INCREMENT,
  `porcentagem` float(3,2) NOT NULL,
  `marca` varchar(50) NOT NULL,
  `validade` date NOT NULL,
  PRIMARY KEY (`id_modificador`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.modificadores: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `modificadores` DISABLE KEYS */;
INSERT INTO `modificadores` (`id_modificador`, `porcentagem`, `marca`, `validade`) VALUES
	(1, 9.99, 'natal2', '2015-12-25'),
	(2, 9.31, 'black_friday', '2015-12-27'),
	(3, 9.99, '10%', '0000-00-00'),
	(4, 9.99, '20% ', '0000-00-00'),
	(5, 9.99, '30%', '0000-00-00'),
	(6, 9.99, '40%', '0000-00-00'),
	(7, 9.99, '50%', '0000-00-00');
/*!40000 ALTER TABLE `modificadores` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.municipios_ibge
...
-- Copiando dados para a tabela frell_codeign.municipios_ibge: ~5.597 rows (aproximadamente)
...
-- Copiando estrutura para tabela frell_codeign.produto
...
-- Copiando dados para a tabela frell_codeign.produto: ~10 rows (aproximadamente)
/*!40000 ALTER TABLE `produto` DISABLE KEYS */;
INSERT INTO `produto` (`id_produto`, `nome`, `descricao`, `tipo`, `valor`) VALUES
	(1, 'p1', 'desc p3', 5, 1.99),
	(2, 'vassoura', 'vassour voador com motor de 8 valvulas', 1, 34.87),
	(3, 'liquidoficador', 'produto que se faz sucos e afins', 5, 89.90),
	(4, 'edredom', 'lençol mas robusto', 2, 99.99),
	(5, 'edredom', 'lençol mas robusto', 2, 99.99),
	(6, 'controle', 'controle', 2, 34.89),
	(7, 'controle2', 'controle', 2, 34.89),
	(8, 'lava louça', 'um lava louça fnomenal', 8, 45.00),
	(9, 'lava louça', 'um lava louça fnomenal', 8, 45.00),
	(10, 'lava louça2', 'um lava louça fnomenal ', 8, 45.00);
/*!40000 ALTER TABLE `produto` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.produto_tag
CREATE TABLE IF NOT EXISTS `produto_tag` (
  `id_ProdutoTag` int(11) NOT NULL AUTO_INCREMENT,
  `fk_produto` int(11) NOT NULL,
  `fk_tag` int(11) NOT NULL,
  PRIMARY KEY (`id_ProdutoTag`),
  KEY `fk_produto` (`fk_produto`,`fk_tag`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.produto_tag: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `produto_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `produto_tag` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.tags
CREATE TABLE IF NOT EXISTS `tags` (
  `id_tag` int(11) NOT NULL AUTO_INCREMENT,
  `tag` varchar(123) NOT NULL,
  PRIMARY KEY (`id_tag`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.tags: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela frell_codeign.tipo
...
-- Copiando dados para a tabela frell_codeign.tipo: ~11 rows (aproximadamente)
...
-- Copiando estrutura para tabela frell_codeign.usuarios
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `uf` varchar(11) DEFAULT NULL,
  `munic` int(11) DEFAULT NULL,
  `endereco` varchar(300) NOT NULL,
  `img` varchar(200) DEFAULT NULL,
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.usuarios: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id`, `nome`, `usuario`, `senha`, `status`, `uf`, `munic`, `endereco`, `img`) VALUES
	(2, 'usuario1', 'fernandoemail@gmail.com', '202cb962ac59075b964b07152d234b70', 'A', 'MS', 120040, '', '25_10_16_11_10_58.jpeg'),
	(5, 'usuario2', 'inserir@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'A', 'PR', 120001, '', '25_10_16_11_10_13.jpeg'),
	(6, 'fernando R', 'fernando_dev@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'A', 'DF', 120001, '', '25_10_16_11_10_11.png'),
	(7, 'usuario3', 'dricar@gmail.com', '202cb962ac59075b964b07152d234b70', 'A', 'PA', 120001, '', '25_10_16_11_10_28.jpeg');
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;


-- Copiando estrutura para tabela frell_codeign.venda
CREATE TABLE IF NOT EXISTS `venda` (
  `id_venda` int(11) NOT NULL AUTO_INCREMENT,
  `fk_cliente` int(11) NOT NULL,
  `fk_pod` int(11) NOT NULL,
  `data_venda` date NOT NULL,
  PRIMARY KEY (`id_venda`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.venda: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `venda` DISABLE KEYS */;
INSERT INTO `venda` (`id_venda`, `fk_cliente`, `fk_pod`, `data_venda`) VALUES
	(1, 3, 3, '1969-02-07'),
	(2, 2, 6, '0000-00-00'),
	(3, 3, 2, '0000-00-00'),
	(5, 2, 7, '0000-00-00');
...
-- Copiando estrutura para tabela frell_codeign.venda_mod
CREATE TABLE IF NOT EXISTS `venda_mod` (
  `id_VendaMod` int(11) NOT NULL AUTO_INCREMENT,
  `fk_mod` int(11) NOT NULL,
  `fk_venda` int(11) NOT NULL,
  PRIMARY KEY (`id_VendaMod`),
  KEY `fk_mod` (`fk_mod`,`fk_venda`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela frell_codeign.venda_mod: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `venda_mod` DISABLE KEYS */;
/*!40000 ALTER TABLE `venda_mod` ENABLE KEYS */;


-- Copiando estrutura para view frell_codeign.view_estoque
-- Criando tabela temporária para evitar erros de dependência de VIEW
CREATE TABLE `view_estoque` (
	`id_produto` INT(11) NOT NULL,
	`produto` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`descricao` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`qtd` INT(12) NOT NULL
) ENGINE=MyISAM;


-- Copiando estrutura para view frell_codeign.view_tipo
-- Criando tabela temporária para evitar erros de dependência de VIEW
CREATE TABLE `view_tipo` (
	`tipo` VARCHAR(35) NOT NULL COLLATE 'latin1_swedish_ci',
	`qtd` BIGINT(21) NOT NULL
) ENGINE=MyISAM;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_estoque` AS select `p`.`id_produto` AS `id_produto`,`p`.`nome` AS `produto`,`p`.`descricao` AS `descricao`,`e`.`qtd` AS `qtd` from (`produto` `p` join `estoque` `e` on((`e`.`id_estoque` = `p`.`id_produto`)));


-- Copiando estrutura para view frell_codeign.view_tipo
-- Removendo tabela temporária e criando a estrutura VIEW final
DROP TABLE IF EXISTS `view_tipo`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_tipo` AS select `t`.`tipo` AS `tipo`,count(`t`.`tipo`) AS `qtd` from (`produto` `p` join `tipo` `t` on((`t`.`id_tipo` = `p`.`tipo`))) group by `t`.`tipo`;
